...
![](000023-pytestx容器化执行引擎/2023-08-23-17-49-09-image.png)
...
![](000023-pytestx容器化执行引擎/2023-08-23-18-04-13-image.png)
...
docker run的`-v`参数将容器报告挂载在后端服务，当报告生成后，后端服务也会生成一份报告文件。再将文件内容返给前端展示：
