...
The [`spring-boot-actuator`](https://github.com/spring-projects/spring-boot/tree/v3.1.1/spring-boot-project/spring-boot-actuator) module provides all of Spring Boot’s production-ready features.
